...
import 'package:dcard/page/Auth/onboarding/botton_buttons.dart';
import 'package:dcard/page/Auth/onboarding/explanation.dart';
import 'package:dcard/utils/colors.dart';
...
class _OnBoardingScreenState
  ...
  Widget build(BuildContext context) {
    return Container(
      padding:
          const EdgeInsets.only(top: 50, left: 20.0, right: 20.0, bottom: 20.0),
